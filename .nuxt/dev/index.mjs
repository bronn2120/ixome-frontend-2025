...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getRequestHost, getRequestProtocol, createError, getQuery as getQuery$1, getResponseStatus, getCookie, setCookie, removeResponseHeader, readBody, setHeader, getRouterParam, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, sendError, getResponseStatusText, H3Error } from 'file:///home/vincent/IxomeAI/frontend/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/vincent/IxomeAI/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///home/vincent/IxomeAI/frontend/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file:///home/vincent/IxomeAI/frontend/node_modules/satori-html/dist/index.js';
import sizeOf from 'file:///home/vincent/IxomeAI/frontend/node_modules/image-size/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withLeadingSlash, withoutTrailingSlash, withBase, withTrailingSlash, withoutProtocol, withoutLeadingSlash, joinRelativeURL, parsePath, decodePath } from 'file:///home/vincent/IxomeAI/frontend/node_modules/ufo/dist/index.mjs';
import consola, { createConsola, consola as consola$1 } from 'file:///home/vincent/IxomeAI/frontend/node_modules/consola/dist/index.mjs';
import { Launcher } from 'file:///home/vincent/IxomeAI/frontend/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file:///home/vincent/IxomeAI/frontend/node_modules/playwright-core/index.mjs';
import { toValue, isVNode, isRef } from 'file:///home/vincent/IxomeAI/frontend/node_modules/vue/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/vincent/IxomeAI/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr, { destr as destr$1 } from 'file:///home/vincent/IxomeAI/frontend/node_modules/destr/dist/index.mjs';
import { parse, stringify, uneval } from 'file:///home/vincent/IxomeAI/frontend/node_modules/devalue/index.js';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/vincent/IxomeAI/frontend/node_modules/unhead/dist/server.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///home/vincent/IxomeAI/frontend/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///home/vincent/IxomeAI/frontend/node_modules/unstorage/drivers/lru-cache.mjs';
import { createHooks } from 'file:///home/vincent/IxomeAI/frontend/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/vincent/IxomeAI/frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/vincent/IxomeAI/frontend/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/vincent/IxomeAI/frontend/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///home/vincent/IxomeAI/frontend/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/vincent/IxomeAI/frontend/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/vincent/IxomeAI/frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/vincent/IxomeAI/frontend/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/vincent/IxomeAI/frontend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { ErrorParser } from 'file:///home/vincent/IxomeAI/frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/vincent/IxomeAI/frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/vincent/IxomeAI/frontend/node_modules/nitropack/node_modules/source-map/source-map.js';
import devalue from 'file:///home/vincent/IxomeAI/frontend/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createRouterMatcher } from 'file:///home/vincent/IxomeAI/frontend/node_modules/vue-router/vue-router.node.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/vincent/IxomeAI/frontend/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file:///home/vincent/IxomeAI/frontend/node_modules/pathe/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///home/vincent/IxomeAI/frontend/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/vincent/IxomeAI/frontend/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///home/vincent/IxomeAI/frontend/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { createGenerator } from 'file:///home/vincent/IxomeAI/frontend/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///home/vincent/IxomeAI/frontend/node_modules/@unocss/preset-wind3/dist/index.mjs';
import { createUnhead } from 'file:///home/vincent/IxomeAI/frontend/node_modules/unhead/dist/index.mjs';
import { Resvg } from 'file:///home/vincent/IxomeAI/frontend/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///home/vincent/IxomeAI/frontend/node_modules/satori/dist/index.js';

const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/home/vincent/IxomeAI/frontend/.nuxt/cache/nuxt-og-image/_fonts"},{"baseName":"server","dir":"/home/vincent/IxomeAI/frontend/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/vincent/IxomeAI/frontend","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/vincent/IxomeAI/frontend/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/vincent/IxomeAI/frontend/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/vincent/IxomeAI/frontend/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/vincent/IxomeAI/frontend/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "stripePublicKey": "pk_live_51RJHGZAg6ajCqPYLlV3AOdWSHBYZ8HqK6am75Nyg8E52cHNQdrvfzA9NDKJqAylZyhKw8T87EQX7zgjb314DzNK2003WLRqyp4",
    "gaId": "UA-XXXXX-X",
    "mdc": {
      "components": {
        "prose": true,
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/home/vincent/IxomeAI/frontend/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-site-config": {
...
const _RE7JDHXb0adEjlpqsWiHKa6g_9u2kP1ys8tHg7Tl_7Y = (function(nitro) {
...
const _l9To6gYfx9ZrQctMt2GAXrZ9ckNKuKyMBvvKXQML08 = defineNitroPlugin(async (nitroApp) => {
...
const componentNames = [{"hash":"lqi2TIJIQMafRl6atyAjEmgaOb13hjqfbfUGe7PXhOw","pascalName":"BrandedLogoDVue","kebabName":"branded-logo-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community"},{"hash":"BMTMwASJKH3AG9ey0Y845iqbPNO7HjNX5eW2U2psVTE","pascalName":"FrameDVue","kebabName":"frame-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.d.vue.ts","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY","pascalName":"Frame","kebabName":"frame","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community"},{"hash":"XHXMYyA3oPy1eN81p4R-wv8k8tkHNooxhCRL8Zs1Pz0","pascalName":"NuxtDVue","kebabName":"nuxt-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.d.vue.ts","category":"community"},{"hash":"NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM","pascalName":"Nuxt","kebabName":"nuxt","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community"},{"hash":"jGeID02J5-Tz9qaGIsRVZfJSXVQS9q-3V2Qnw65GQMg","pascalName":"NuxtSeoDVue","kebabName":"nuxt-seo-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.d.vue.ts","category":"community"},{"hash":"VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community"},{"hash":"XHXMYyA3oPy1eN81p4R-wv8k8tkHNooxhCRL8Zs1Pz0","pascalName":"PergelDVue","kebabName":"pergel-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.d.vue.ts","category":"community"},{"hash":"8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM","pascalName":"Pergel","kebabName":"pergel","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community"},{"hash":"7-N5uiZ77GftW16gAKUKdbC2kTqoiWjlYDsNWxCsCG4","pascalName":"SimpleBlogDVue","kebabName":"simple-blog-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.d.vue.ts","category":"community"},{"hash":"b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community"},{"hash":"ahhiG3dVaeRX0C50qOnvcUsjBRro4ufe-6jzsUbVxBY","pascalName":"UnJsDVue","kebabName":"un-js-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.d.vue.ts","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI","pascalName":"UnJs","kebabName":"un-js","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community"},{"hash":"pzp5dWaNkZa2Gbj-RXhoDiBahvrINMjPJC9-Vs2OtxE","pascalName":"WaveDVue","kebabName":"wave-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw","pascalName":"Wave","kebabName":"wave","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community"},{"hash":"hsZbjduIx-cfHCcgbOY44VlwFWt5bfWv-VxiGiUifDs","pascalName":"WithEmojiDVue","kebabName":"with-emoji-d-vue","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/home/vincent/IxomeAI/frontend/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community"}];
...
const _A8I8i3r_OXm5ZpISowbPhOky9IfdmypmISmVebZOjIg = defineNitroPlugin(async (nitro) => {
  return;
});
...
const checksums = {
  "blog": "v3.5.0--NimRVDm4wNNiqJvWLSvdX2eAqWPXxH2yhBPM5_B3xak"
};
...
const _nuKGrFIGZqkFRIwAbl8kR4XB1C68uHT5qpxsHc7N2s0 = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/e0vwsWL4") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const rootDir = "/home/vincent/IxomeAI/frontend";
...
const _KQBbC1cPOPXYLDmtYw1_WeEtREh74uXnc1f5LMsj_w = (nitroApp) => {
...
const plugins = [
  _RE7JDHXb0adEjlpqsWiHKa6g_9u2kP1ys8tHg7Tl_7Y,
_l9To6gYfx9ZrQctMt2GAXrZ9ckNKuKyMBvvKXQML08,
_A8I8i3r_OXm5ZpISowbPhOky9IfdmypmISmVebZOjIg,
_nuKGrFIGZqkFRIwAbl8kR4XB1C68uHT5qpxsHc7N2s0,
_KQBbC1cPOPXYLDmtYw1_WeEtREh74uXnc1f5LMsj_w
];
...
const _juHWfw = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/vincent/IxomeAI/frontend/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/vincent/IxomeAI/frontend/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _Nv4GGe = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _UH7oj0 = eventHandler(async (e) => {
  const siteConfig = getSiteConfig(e);
  const nitroOrigin = getNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _Wz7n6J = _messagesHandler ;

const _AucVhF = eventHandler(async (event) => {
  ...
  return await import('file:///home/vincent/IxomeAI/frontend/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _Q8sgZv = eventHandler(async (event) => {
...
const _lazy_PZbNyr = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_XjlgN9 = () => Promise.resolve().then(function () { return font$1; });
const _lazy_mZFk09 = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_zO4u3x = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '', handler: _juHWfw, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_PZbNyr, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_XjlgN9, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _Nv4GGe, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _UH7oj0, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_mZFk09, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_zO4u3x, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_zO4u3x, lazy: true, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _Wz7n6J, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _AucVhF, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _Q8sgZv, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_PZbNyr, lazy: true, middleware: false, method: undefined }
];
